...
const Mainresto = ({ data }) => {
  const { name, avgRating, cuisines, areaName, aggregatedDiscountInfoV3, cloudinaryImageId, id, sla} = data
  return (
      ...
      <div className="pt-4 ">
        ...
        <div className="w-[321px]  pr-8 pl-4  hover:scale-90 duration-300 overflow-x-auto">
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 rounded-bl-2xl bg-gray-400 font-bold text-gray-900">{aggregatedDiscountInfoV3?.header} {aggregatedDiscountInfoV3?.subHeader}</div>
          </div>
